---
name: power-of-breakthrough-coauthor
description: Participate in the collaborative writing of the Chinese book 《破圈力》 by preparing a reviewable contribution package, checking evidence and rights, validating it locally, and opening a scoped GitHub Pull Request. Use for corrections, evidence, cases, tools, rewrites, or new-section proposals; do not edit the canonical book directly.
---
...
Fork `flyingpig707/PowerofBreakthrough`, create a branch, and work only under:
...
- Explain how the proposal relates to perception, generation, connection, or evolution capability, and whether it changes the organizational, assessment, or ecosystem layer.
