...
```text
阅读 https://github.com/flyingpig707/PowerofBreakthrough/tree/main/skills/power-of-breakthrough-coauthor 并参与《破圈力》共同写作
```

完整流程和文件格式由 [`skills/power-of-breakthrough-coauthor/SKILL.md`](skills/power-of-breakthrough-coauthor/SKILL.md) 说明。也可以先创建“共同写作提案”Issue，与维护者确认范围。

## 适合提交的内容

- 错别字、格式、链接或图片问题；
- 数据、引文和案例的原始来源补充；
- 对“四力模型”、AI-5A、GEO与认知主权等框架的边界与反例；
- 可公开核验的城市传播与治理实践案例；
- 随书工具的使用反馈和改进建议。
