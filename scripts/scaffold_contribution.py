#!/usr/bin/env python3
"""Create a new 《破圈力》 contribution package from the canonical template."""
...
TEMPLATE = ROOT / "skills" / "power-of-breakthrough-coauthor" / "assets" / "submission-template"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chapter", required=True, help="For example: 09-连接之力 or NEW")
